...
class Outside(models.Model):
    ...
    photo = models.ImageField(upload_to="outside/", null=True, blank=True)
...
class Topic(models.Model):
    ...
    problem_info = RichTextUploadingField(config_name='default', blank=True, null=True)
    action = RichTextUploadingField(config_name='default', null=True, blank=True)
...
class Activity(models.Model):
    ...
    action_description = RichTextUploadingField(null=True, blank=True)
